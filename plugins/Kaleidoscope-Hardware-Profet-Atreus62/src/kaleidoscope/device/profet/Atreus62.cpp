...
using KeyScannerProps = typename kaleidoscope::device::profet::Atreus62Props::KeyScannerProps;
using KeyScanner = typename kaleidoscope::device::profet::Atreus62Props::KeyScanner;
